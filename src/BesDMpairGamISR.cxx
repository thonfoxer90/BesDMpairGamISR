...
#endif
#include "../BesDMpairGamISR/BesDMpairGamISR.h"
...
BesDMpairGamISR::BesDMpairGamISR(const std::string& name, ISvcLocator* pSvcLocator) :
...
StatusCode BesDMpairGamISR::initialize(){
...
StatusCode BesDMpairGamISR::execute()
{
  MsgStream log(msgSvc(), name());
...
StatusCode BesDMpairGamISR::finalize() {
  MsgStream log(msgSvc(), name());
